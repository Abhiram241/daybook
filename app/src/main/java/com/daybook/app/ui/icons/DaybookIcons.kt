...
object DaybookIcons {
    ...
    /** B6 (§7.4) — Round B's Health tab nav icon, built in code exactly like [Clock]/[Category]
     *  (§0's precedent) rather than pulling in `material-icons-extended` for one glyph. */
